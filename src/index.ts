...
const inputLänge = document.querySelector<HTMLInputElement>("[data-length]");                     //Länge
const spanLängenanzeige = document.querySelector<HTMLSpanElement>("[data-current-length]");       //Längenanzeige (Zahl)
